...
## Aspect important du TP :cyclone:
...
- :warning: Son but du jeu est de ne pas dépasser la valeur de pollution de 100 et de ne pas tomber la valeur de ressource inférieur à 0. De plus, il faut atteindre la tour 10 pour gagner. :warning:

### 1. Jeu de tour à tour (Si vous choisissez cette partie) :tulip:
...
### 2. Actions et événements :cherry_blossom:
...
### 3. Jeu automatique (Si vous choisissez cette partie) :four_leaf_clover:
...
### 4. Choix stratégique pour le calcul du score :rose:
...
## Mode d'utilisation (SANS GTK) :mushroom:

### 1. Installation :chestnut:
...
### 4. Exemple avec les images de test :blossom:
...
### 5. Avant de terminer :fallen_leaf:
...
## Mode d'utilisation (AVEC GTK) :cherries:
...
## Documentations utilisées :volcano:

### Cours :hatching_chick:
